...
\centering
        ...
        \begin{subfigure}{6.3cm}
		 ...
		 grid=both,
            ...
            \begin{axis}[
                ...
                \addplot [mark=none ,stack plots=y, stack dir=minus,line width=1.2pt, CarnationPink, dashed] table [x=Y, y=λ_ets_mean, col sep=comma]{\dataaiq};
            \end{axis}
    ...
    % Panel 3: Steel Price
        \begin{subfigure}{6.3cm}
            ...
            \begin{axis}[
                ...
                \addplot [mark=none ,stack plots=y, stack dir=minus,line width=1.2pt, CarnationPink, dashed] table [x=Y, y=λ_ets_mean, col sep=comma]{\dataaiiq};
            \end{axis}
            \end{tikzpicture}            % Bar 3
                      \begin{tikzpicture}
            \begin{axis}[
   ...
   % Bar 2
            ...
            \begin{axis}[
                ...
                \addplot [mark=none ,stack plots=y, stack dir=minus,line width=1.2pt, CarnationPink, dashed] table [x=Y, y=λ_ets_mean, col sep=comma]{\dataaq};
            \end{axis}
            \end{tikzpicture}            % Bar 3
                      \begin{tikzpicture}
            \begin{axis}[

...
\def \data {../results/scenario_1_103.csv}
...
\addtocounter{subfigure}{3}
  ...
  %  \addplot[name path=mean, line width=1pt, dashed, gray] table [x=Y, y=BF-BOF_b_mean, col sep=comma]{\refr};
     %     \addlegendentry{(ref.)}
         ...
         % BF with NG blending
%    \addplot[name path=mean, line width=1.5pt, RawSienna] 
%        table [x=Y, y=BF-BlendNG-BOF_b_mean, col sep=comma]{\data};
%          \addlegendentry{BF with NG blending}
%    \addplot[name path=mean, line width=1pt, dashed, RawSienna] table [x=Y, y=BF-BlendNG-BOF_b_mean, col sep=comma]{\refr};
%          \addlegendentry{(ref.)}
    ...
    %\addplot[name path=mean, line width=1pt, dashed, cyan] table [x=Y, y=BF-BOF-CC_b_mean, col sep=comma]{\refr};
       %   \addlegendentry{(ref.)}
        ...
        % NGDRI
%    \addplot[name path=mean, line width=1.5pt, CarnationPink] 
%        table [x=Y, y=NGDRI-EAF_b_mean, col sep=comma]{\data};
%          \addlegendentry{NG DRI}
%    \addplot[name path=mean, line width=1pt, dashed, CarnationPink] table [x=Y, y=NGDRI-EAF_b_mean, col sep=comma]{\refr};
%          \addlegendentry{(ref.)}
   ...
   \addplot[name path=lower, draw=none] 
    ...
    \addplot[gray!40, fill opacity=0.6] fill between[of=lower and upper];
    ...
    \addplot[RawSienna!40, fill opacity=0.6] fill between[of=lower and upper];
    
                  
    \addplot[name path=lower, draw=none] 
        table [x=Y, y=BF-BOF-CC_b_Q1, col sep=comma]{\data};
    \addplot[name path=upper, draw=none] 
        table [x=Y, y=BF-BOF-CC_b_Q3, col sep=comma]{\data};
    \addplot[cyan!40, fill opacity=0.6] fill between[of=lower and upper];

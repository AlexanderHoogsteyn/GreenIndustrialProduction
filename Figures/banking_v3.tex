...
% Paths and variables
\def \data {../results/scenario_deterministic_3.csv}
%\def \data {../results/combined_stochastic_4.csv}
%\def \data {../results/rolling_horizon_stochastic_11.csv}
\def \refr {../results/scenario_deterministic_1.csv}
\def \from {2025}
\def \till {2046}
...
%\addtocounter{subfigure}{3}
    ...
    \begin{tikzpicture}
    \node[rotate=90, anchor=south, font=\bfseries] at (-1.9,2.2) {Financial constraints};
    \begin{axis}[
          height=6cm,
          width=6cm,
          xlabel= Year,
...
\begin{subfigure}{6.3cm}
   \begin{tikzpicture}
    \begin{axis}[
          ...
          grid=both,
          xmin=\from, xmax=\till,
          ymin=0, ymax=400, % Adjust based on your data range
          /pgf/number format/1000 sep={},
         ]
